...
CREATE TABLE country (you guyz tell
...
\copy batting_style from '/home/sanjeev/Desktop/db-ass-1/IPL DB/IPL DB/batting_style.csv' delimiter ',' csv header;
\copy bowling_style from '/home/sanjeev/Desktop/db-ass-1/IPL DB/IPL DB/bowling_style.csv' delimiter ',' csv header;
\copy out_type from '/home/sanjeev/Desktop/db-ass-1/IPL DB/IPL DB/out_type.csv' delimiter ',' csv header;
\copy outcome from '/home/sanjeev/Desktop/db-ass-1/IPL DB/IPL DB/outcome.csv' delimiter ',' csv header;
\copy country from '/home/sanjeev/Desktop/db-ass-1/IPL DB/IPL DB/country.csv' delimiter ',' csv header;
\copy role from '/home/sanjeev/Desktop/db-ass-1/IPL DB/IPL DB/role.csv' delimiter ',' csv header;
\copy team from '/home/sanjeev/Desktop/db-ass-1/IPL DB/IPL DB/team.csv' delimiter ',' csv header;
\copy win_by from '/home/sanjeev/Desktop/db-ass-1/IPL DB/IPL DB/win_by.csv' delimiter ',' csv header;
\copy player from '/home/sanjeev/Desktop/db-ass-1/IPL DB/IPL DB/player.csv' delimiter ',' csv header;
\copy season from '/home/sanjeev/Desktop/db-ass-1/IPL DB/IPL DB/season.csv' delimiter ',' csv header;
\copy match from '/home/sanjeev/Desktop/db-ass-1/IPL DB/IPL DB/match.csv' delimiter ',' csv header;
\copy player_match from '/home/sanjeev/Desktop/db-ass-1/IPL DB/IPL DB/player_match.csv' delimiter ',' csv header;
\copy ball_by_ball from '/home/sanjeev/Desktop/db-ass-1/IPL DB/IPL DB/ball_by_ball.csv' delimiter ',' csv header;
\copy batsman_scored from '/home/sanjeev/Desktop/db-ass-1/IPL DB/IPL DB/batsman_scored.csv' delimiter ',' csv header;
\copy wicket_taken from '/home/sanjeev/Desktop/db-ass-1/IPL DB/IPL DB/wicket_taken.csv' delimiter ',' csv header;
...
select result.season_year, result.match_id, result.team_name from result where result.rk in (1, 2, 3) ;
